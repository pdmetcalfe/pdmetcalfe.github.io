#set document(title: [On training])
#metadata((
  title: "On training",
  kind: "post",
  date: "2015-11-11",
  tags: ("R", "rants"),
  summary: "nobody can learn things for you",
)) <website-metadata>
...
are libraries.  There's even
#link("https://en.wikipedia.org/wiki/Main_Page")[wikipedia].  There's
lots of ways that you can learn if you want to find out how to do
something.  None of them involve me learning it for you first.  If you
say "I need training on _specific technical skill_" you're telling me
that you have abdicated the responsibility for your own learning.
Good for you.  It doesn't make it my problem. (Yes, I know. It's hard
work.  Tough.  There is no royal road to geometry.)
...
you to #link("https://web.mit.edu/6.001/6.037/sicp.pdf")[SICP].
