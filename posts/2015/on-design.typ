#set document(title: [Shooting fish in the software engineering barrel])
#metadata((
  title: "Shooting fish in the software engineering barrel",
  kind: "post",
  date: "2015-11-11",
  tags: ("design", "philosophy"),
  summary: "why '15 arguments is fine' is not an argument",
)) <website-metadata>
...
argument along the following lines.#footnote[It's a pretty absurd reductio ad absurdum.]
...
- I hear Maxwell's equations aren't completely accurate; perhaps you
  ...
  electrodynamics.#footnote[Or one of those grand unified theories that
  the physicists are going to come up with Any Day Now.]

When you're writing code you're trying to organize ideas.  You aren't
really trying to get a result.#footnote[I'll get complaints for this.]
